...
func testLiveMeetingCodexSession() {
    runSuite("LiveMeetingCodexSession.ensureWorkspaceFiles - creates the sidecar workspace") {
        ...
        assertTrue(previewText.contains("aria-label=\"Live transcript\""), "preview should make the transcript the main surface")
        assertFalse(previewText.contains("scratchpad"), "preview should not show a note-taking surface")
        assertFalse(previewText.contains("transcript-toggle"), "preview should not hide the transcript behind a toggle")
        assertFalse(previewText.contains("recorder-dock"), "preview should not show fake recording controls")
        assertFalse(previewText.contains("waveform"), "preview should not show a fake audio visualizer")
        assertFalse(previewText.contains("stop-square"), "preview should not show a fake stop button")
        ...
        assertFalse(previewText.contains("localStorage"), "preview should not persist browser-local notes")
