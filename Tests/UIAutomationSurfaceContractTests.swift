...
func testUIAutomationSurfaceContract() {
    ...
    runSuite("UI automation surface contract - deterministic click-flow identifiers stay mapped") {
        ...
        for identifier in [
            ...
            "transcripted.settings.general.disclosure.send-after-dictation",
            "transcripted.settings.general.disclosure.speaker-matching",
            "transcripted.settings.general.disclosure.permissions",
