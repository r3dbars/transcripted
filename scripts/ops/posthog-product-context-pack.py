    ...
    *,
    ...
    if not has_observed_overview:
        ...
        recs.append({
            ...
            "suggested_pr": "Verify the read-only MCP/agent surface is emitting aggregate-only `agent_capture_query_observed` rows for current builds, with enum client family, tool kind, capture kind, result, and source-count buckets.",
        })
