...
usage() {
  cat <<'USAGE'
Usage: bash scripts/ops/transcripted-qa-bench.sh [--mode quick|deep|full|ui|imported-audio-native|packaged|artifact|audio-synthetic|pasteback-synthetic|corpus|corpus-compare|scorecard|live] [options]
...
case "$MODE" in
  quick|deep|full|ui|imported-audio-native|packaged|artifact|audio-synthetic|pasteback-synthetic|corpus|corpus-compare|scorecard|live) ;;
  *)
