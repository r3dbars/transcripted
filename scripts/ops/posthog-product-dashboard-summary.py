...
def build_under_discovered_feature(data: dict[str, Any]) -> Finding:
    ...
    candidates = [
        ...
        ("Local summary", max(devices.get("local_meeting_summary_started", 0), devices.get("local_meeting_summary_completed", 0), devices.get("local_meeting_summary_cancelled", 0)), 3, "Make the saved-meeting summary action clearer on Home."),
