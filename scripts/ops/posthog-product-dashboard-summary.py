...
SELECT
  ...
  countIf(event IN ('dictation_started', 'meeting_recording_started')) AS core_start_events,
  ...
  uniqIf(distinct_id, event IN ('meeting_recording_started', 'meeting_transcript_saved')) AS meeting_devices,
