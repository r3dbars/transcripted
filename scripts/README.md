...
- `bash Tests/BuildDependencies/ArchiveInputsTests.sh` — exercises the dependency archive's executable-target filter and entry-point guards without compiling/downloading dependencies; actual builds also validate archive symbols
