...
QA testing suite for Transcripted. 22 source/test Swift files plus `Package.swift` (23 `.swift` files total) across Commands/, Generators/, Validators/, Utilities/, Models/, and root.
