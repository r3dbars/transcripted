...
**Why not direct OAuth PKCE?** Anthropic blocked third-party apps from implementing the OAuth flow directly (Jan 2026). `setup-token` is the officially sanctioned path.
