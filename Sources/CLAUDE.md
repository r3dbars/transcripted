...
- `Support/TranscriptionModelPreferences.swift` — persisted local model selection shared by dictation and meetings (Parakeet TDT V3 / V2, Whisper Large V3 Turbo, Whisper Large V3)
...
- touching the Settings window, Home, onboarding, or speaker settings files: also `Sources/UI/Settings/CLAUDE.md`
