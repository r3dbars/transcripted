...
- Retired `AVAudioEngine` instances have a hard process-wide cap while late CoreAudio callbacks drain. Once full, Transcripted refuses another replacement, reuses a successfully reset graph when safe, and never allocates a fifth retired native graph.
