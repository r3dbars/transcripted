...
enum MeetingOverlayTokens {
    ...
    static let headerGap: CGFloat   = UISpacing.sm
    static let standardPad: CGFloat = UISpacing.md
    ...
    static let minimizedPadLeft: CGFloat = UISpacing.compact
    static let minimizedGap: CGFloat = UISpacing.tight
    ...
    static let promptPad: CGFloat = UISpacing.md
    static let promptButtonHeight: CGFloat = 24
    static let promptButtonGap: CGFloat = UISpacing.sm
    static let warmupPad: CGFloat = UISpacing.lg
