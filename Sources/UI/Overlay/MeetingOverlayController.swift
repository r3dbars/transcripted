...
final class MeetingOverlayPanel: NSPanel {
    override init(
        ...
        // ScreenCaptureKit captures — so a user sharing a recorded call would
        // paint the other party's transcribed "Them:" lines back onto the
        // shared screen with no macOS warning.
...
final class MeetingOverlayTooltipPanel: NSPanel {
    ...
    init() {
        ...
        // Keep the meeting overlay's hover tooltip out of screen capture too,
        // matching the recording panel and live transcript drawer.
        self.sharingType = .none
