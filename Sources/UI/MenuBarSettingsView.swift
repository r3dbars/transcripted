...
// Settings popover content: transcription engine, shortcuts, feedback, quit
...
final class MenuBarSettingsView: NSView {
    ...
    private let engineHint = NSTextField(labelWithString: "Local dictation plus offline meeting transcription")
