...
extension StatsDatabase {
    ...
    private func getRecordingsImpl(from startDate: Date, to endDate: Date) -> [RecordingMetadata] {
        ...
        let startStr = DateFormattingHelper.formatDayStamp(startDate)
        let endStr = DateFormattingHelper.formatDayStamp(endDate)
    ...
    private func getDailyActivityImpl(for month: Date) -> [String: DailyActivity] {
        ...
        let startStr = DateFormattingHelper.formatDayStamp(startOfMonth)
        let endStr = DateFormattingHelper.formatDayStamp(endOfMonth)
