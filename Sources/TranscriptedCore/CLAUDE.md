...
- `.pyannote` (default) — `OfflineDiarizerManager` (community-1 segmentation + WeSpeaker + VBx) with the grid-searched config. Every existing caller gets this unchanged.
