...
/// Pulls the transcript body out of a saved meeting's Markdown: strips
/// frontmatter, then narrows to the `## Transcript` / `## Full Transcript`
/// section when present. Dependency-free so it can run on every save.
