...
11. Imported jobs use their journal UUID as the transcript UUID. Recovery skips a live lease owner and rejects non-regular scratch entries. A committed phase or matching saved transcript prevents replay; only the separate durable cleanup-pending phase authorizes deletion, so archive failures keep their sole audio copy.
