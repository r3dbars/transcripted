...
| `meeting_speaker_review_prompted` | A saved meeting has review work surfaced | `participant_count_bucket`, `unresolved_count_bucket`, `review_reason`, `surface`, `result`, `action`, `meeting_age_bucket` |
| `meeting_speaker_review_actioned` | User acts inside the speaker review surface | `participant_count_bucket`, `unresolved_count_bucket`, `review_reason`, `surface`, `action`, `result`, `meeting_age_bucket`, `update_count_bucket` |
| `meeting_speaker_review_completed` | User completes or dismisses speaker review | `participant_count_bucket`, `unresolved_count_bucket`, `review_reason`, `surface`, `result`, `meeting_age_bucket`, `update_count_bucket` |
