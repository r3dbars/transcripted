...
- live preview: `~/Library/Application Support/Transcripted/CodexLiveMeeting/preview.html`
...
transcript so it can be opened directly without running a local web server.
