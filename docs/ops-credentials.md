...
The true-use event is `agent_capture_query_observed`, emitted from the MCP/tool
query path with only client family, tool kind, capture kind, result, and
source-count bucket.
