...
Recon pass for the Draft + Transcripted merge. Scope: read-only inventory of `~/redbars/code/Draft`
...
Directory: `/Users/redbars/redbars/code/Draft`
...
- `UpdateManager.swift` (~225 lines) — DMG download, mount, staged app replacement with backup/rollback,
  version comparison via Info.plist, user-facing update prompts, team ID verification (`XG6WL66WUQ`).
